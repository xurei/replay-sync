  ...
  return function() {
    ...
    var e = {
      729: function(e) {
        ...
        Object.create && (r.prototype = Object.create(null), (new r).__proto__ || (n = !1)), s.prototype.eventNames = function() {
          ...
          var l, u, c = this._events[s], p = arguments.length;
          if (c.fn) {
            ...
            for (u = 0; u < f; u++) switch (c[u].once && this.removeListener(e, c[u].fn, void 0, !0), p) {
              ...
              case 4:
                ...
                break;
              default:
                if (!l) for (d = 1, l = new Array(p - 1); d < p; d++) l[d - 1] = arguments[d];
    ...
    return function() {
      ...
      ***************************************************************************** */
      ...
      var i, a, s, l, u = n(729), c = 'twitch-embed-player-proxy';
      !function(e) {
      ...
      function g(e, t) {
        var n = 'https://' + t + '.twitch.tv' + '?' + m.Pz(o(o({}, e), {parent: b(e.parent), referrer: document.location.href})),
      ...
      var _ = {
        ...
        return t(n, e), n.prototype._setWindowRef = function(e) {
          ...
          if (this._embedWindow) {
            var t = e.data, n = e.source === this._embedWindow, r = t.namespace === c, o = t.eventName === i.UpdateState;
        ...
        function n(t, n) {
          ...
          return r._options = {}, r._target = null, r._player = new E, r._eventEmitter = null, r._iframe = null, r._forwardEmbedEvents = function(e) {
            if (r._iframe) {
              var t = e.data, n = e.source === r._iframe.contentWindow, o = 'twitch-embed' === t.namespace;
              n && r._eventEmitter.emit(t.eventName, t.params)
            }
